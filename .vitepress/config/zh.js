...
const sidebar = {
  '/zh': [
    {
      text: '项目预览',
      items: [{ text: 'Link', link: '/zh/preview/' }],
    },
    {
      text: '八股文 && 面试题',
      items: [
        { text: 'HTML', link: '/zh/interview/html' },
        { text: 'JS && TS', link: '/zh/interview/js' },
        { text: 'Vue ', link: '/zh/interview/vue' },
        { text: '原理', link: '/zh/interview/theory' },
        { text: '优化手段', link: '/zh/interview/optimization' },
      ],
    },
    {
      text: '亮难点（项目 && 场景）',
      items: [
        { text: '优化', link: '/zh/highlight/optimization' },
        { text: '方案', link: '/zh/highlight/scheme' },
        { text: '组件封装', link: '/zh/highlight/comp' },
      ],
    },
    {
      text: '数据结构',
